...
import { SdkHandlersProvider, LoggerSymbol, ILogger, AppDidMountPromiseSymbol } from '@wix/thunderbolt-symbols'
...
export const siteMembersWixCodeSdkHandlers = withDependencies(
	[SiteMembersApiSymbol, LoggerSymbol, AppDidMountPromiseSymbol],
