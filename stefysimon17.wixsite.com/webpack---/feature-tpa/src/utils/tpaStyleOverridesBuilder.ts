...
import { TpaCompStyleOptions, TpaPopupOrigin, TpaPopupPlacement, TpaStyleOverrides } from '../types'
...
export const computeTpaPopupStyleOverrides = (
	...
	const originalCompStyle: OriginalCompStyle = {
		left: bounds ? bounds.left + window.pageXOffset : 0,
		top: bounds ? bounds.top + window.pageYOffset : 0,
