...
export const TpaComponentApi = withDependencies(
	...
	(
		{ widgetsClientSpecMapData, deviceType, isMobileView }: TpaCommonsSiteConfig,
		...
		getDefaultProps(widgetId, iframeStartedLoadingCallback) {
			...
			return {
				...
				isMobileView,
				allowScrolling,
				reportIframeStartedLoading: iframeStartedLoadingCallback || _.noop,
			}
		},
	})
)
